...
public class HashMapOfDataServerFG {
	...
	public void setValue (String name,double value) {
		FG_ClientHandler.getHelper().pathAndValueFromFG.get(nameToPath.get(name));}
	...
	public void updateValue(String name,double value) {
		FG_ClientHandler.getHelper().pathAndValueFromFG.replace(nameToPath.get(name),value);
	}
	public void updatePath(String name,String path) {
		nameToPath.replace(name, path);
	}
